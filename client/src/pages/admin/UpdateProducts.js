      ...
      <div className='row'>
        ...
        <div className='col-md-9'>
            ...
            <div className='m-1 w-75'>
              ...
              <div className='mb-3'>
                <Select bordered={false} placeholder='Select Shipping' size='large' showSearch className='form-control mb-3' onChange={(value)=>{setShipping(value)}} value={shipping ? 'Yes' : 'No'}>
